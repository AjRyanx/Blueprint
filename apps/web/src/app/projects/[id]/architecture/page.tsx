  ...
  return (
    ...
    >
      <div className="p-6 max-w-5xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold">System Architecture Design</h1>
          <p className="text-muted-foreground text-sm mt-1">
            Phase 3 — Define your system architecture, technology stack, and key design decisions.
          </p>
        </div>
        <ArchitectureDesigner projectId={projectId} />
      </div>
    </AppShell>
  );
}
